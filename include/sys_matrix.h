...
extern UltraMtx* _MtxF_to_Mtx(MtxF* src, UltraMtx* dest);
extern UltraMtx* _Matrix_to_Mtx(UltraMtx* dest);
extern UltraMtx* _Matrix_to_Mtx_new(GRAPH* graph);
...
extern void Matrix_MtxtoMtxF(UltraMtx* src, MtxF* dest);
...
extern void suMtxMakeTS(UltraMtx* m, f32 scaleX, f32 scaleY, f32 scaleZ, f32 translateX, f32 translateY, f32 translateZ);
extern void suMtxMakeSRT(UltraMtx* m, f32 scaleX, f32 scaleY, f32 scaleZ, s16 rotX, s16 rotY, s16 rotZ, f32 translateX, f32 translateY, f32 translateZ);
extern void suMtxMakeSRT_ZXY(UltraMtx* m, f32 scaleX, f32 scaleY, f32 scaleZ, s16 rotX, s16 rotY, s16 rotZ, f32 translateX, f32 translateY, f32 translateZ);
